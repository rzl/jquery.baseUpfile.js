...
},plugins:["draggable","layouttitle","bxButton","droppable","resizable","pagination","tooltip","linkbutton","menu","menubutton","splitbutton","switchbutton","progressbar","tree","textbox","passwordbox","filebox","combo","combobox","combotree","combogrid","combotreegrid","tagbox","numberbox","validatebox","searchbox","spinner","numberspinner","timespinner","datetimespinner","calendar","datebox","datetimebox","slider","layout","panel","datagrid","propertygrid","treegrid","datalist","tabs","accordion","window","progressbar","dialog","form"],parse:function(_c){
var aa=[];
...
(function($){
	$.topWindow=function(id,param){
		if (top.$(id).length>0||top.$('body').append('<div id="'+id.replace('#','')+'" style="overflow:hidden"></div>')){
			top.$(id).window(param);
		}
	}
})(jQuery);
